...
class Loops extends Component {
    ...
    // mutePlayer(value, index) {
    //     this.state.muteColumns[index] = value
    //     this.setState({ 'muteColumns': this.state.muteColumns})
    // }
    ...
    render() {
        return (
            <div className='loops'>
                ...
                {/* <button className='main-btn' onClick={this.mutePlayer}>Mute</button> */}
            </div>
        )
    }
}
